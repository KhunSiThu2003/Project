<template>
  <div class="container mx-auto px-4 py-4 md:py-8">
    <div class="max-w-2xl mx-auto">
            ...
            <div class="flex items-center space-x-3 md:space-x-4">
              <div class="relative">
                ...
                <div 
                  ...
                  :class="isOnline(user.id) ? 'bg-green-500' : 'bg-gray-400'"
                ></div>
              </div>
              <div class="flex flex-col">
                ...
                <span class="text-xs mt-1" :class="isOnline(user.id) ? 'text-green-500' : 'text-gray-500 dark:text-gray-400'">
      ...
      <!-- No Results -->
      <div v-else-if="searchQuery && !loading" class="text-center py-8 md:py-16 bg-gray-50 rounded-lg md:rounded-2xl border border-gray-100 dark:bg-gray-800 dark:border-gray-700">
