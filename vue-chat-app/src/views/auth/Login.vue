    ...
    <form @submit.prevent="handleLogin" class="space-y-6">
      <div>
        ...
        <div class="mt-1 relative">
          ...
          <div class="absolute inset-y-0 right-0 rtl:right-auto rtl:left-0 pr-3 rtl:pr-0 rtl:pl-3 flex items-center">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          <input id="remember-me" v-model="form.rememberMe" type="checkbox"
            class="h-4 w-4 text-primary-500 focus:ring-primary-500 border-gray-300 dark:border-gray-700 rounded" />
          <label for="remember-me" class="ml-2 rtl:ml-0 rtl:mr-2 block text-sm text-gray-700 dark:text-gray-300">
            {{ $t('auth.rememberMe') }}
          </label>
        </div>
